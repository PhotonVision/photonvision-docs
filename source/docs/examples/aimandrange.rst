...
The following example is from the PhotonLib example repository (`Java <https://github.com/PhotonVision/photonlib-examples/tree/master/java/aim-and-range>`_/`C++ <https://github.com/PhotonVision/photonlib-examples/tree/master/cpp/aim-and-range>`_).
