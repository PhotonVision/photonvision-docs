...
.. note::
   Setting the mode to -1 (default) when multiple cameras are connected may result in unexpected behavior. :ref:`This is a known-limitation of PhotonVision. <docs/other/known-issues: led-control>`
